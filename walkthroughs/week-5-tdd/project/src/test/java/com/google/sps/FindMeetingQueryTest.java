...
public final class FindMeetingQueryTest {
  ...
  // OPTIONAL ATTENDEES TESTS:
  @Test
  public void optionalAttendeeNotAvailable() {
    // Have each person have different events. The optional attendee C has a full day event, so
    // they won't be considered when returning the available slots.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void onlyOptionalAttendees() {
    // All attendees are optional.
    // Have each person have different events. We should see 3 options because 
    // the optional attendees can go.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void onlyOptionalAttendeesNoTime() {
    // All attendees are optional. However, since they have no free time, there
    // are no availabele slots for time.
    //
    // Events  : |--A-----| |-----B----|
    // Day     : |---------------------|
    // Options :
